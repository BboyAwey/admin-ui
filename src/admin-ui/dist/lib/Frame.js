define("Frame", [], function() { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/* harmony default export */ var framevue_type_script_lang_js_ = ({
  ...
  methods: {
    resize: function resize() {
      var headerSize = Object(get_element_size["a" /* default */])(this.$refs.header);
      var containerSize = Object(get_element_size["a" /* default */])(this.$refs.container);
      var contentMainSize = Object(get_element_size["a" /* default */])(this.$refs.contentMain);
      var footerSize = null;
      if (this.footerShow) footerSize = Object(get_element_size["a" /* default */])(this.$refs.footer); // resize the container of page main part height to full the screen
