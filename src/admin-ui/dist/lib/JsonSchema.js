define("JsonSchema", ["Vue"], function(__WEBPACK_EXTERNAL_MODULE__74__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var es7_array_includes = __webpack_require__(105);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es6.string.includes.js
var es6_string_includes = __webpack_require__(106);
...
/* harmony default export */ var selectvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    resize: function resize() {
      var height = Object(get_element_size["a" /* default */])(this.$refs.selectMultiple).height;
...
/* harmony default export */ var src_select = __webpack_exports__["a"] = (component.exports);
...
// EXTERNAL MODULE: ./src/admin-ui/src/components/select/src/select.vue + 3 modules
var src_select = __webpack_require__(237);

// EXTERNAL MODULE: ./src/admin-ui/src/components/radio/src/radio.vue + 3 modules
var src_radio = __webpack_require__(255);
...
/* harmony default export */ var json_schemavue_type_script_lang_js_ = ({
  ...
  components: {
    ...
    AuSelect: src_select["a" /* default */],
    AuIcon: icon["a" /* default */],
    AuModal: modal["a" /* default */],
    AuRadio: src_radio["a" /* default */]
  },
  props: {
    _index: Number,
    _key: String,
  ...
  data: function data() {
    return {
      localSchema: this._isRoot ? Object(deep_clone["a" /* default */])(this.schema) : this.schema,
      showChildren: true,
      currentItem: {
        __key: '',
        __custom: {},
      ...
      handler: function handler(v) {
        if (this._isRoot) {
          if (JSON.stringify(v) !== JSON.stringify(this.purifySchema(this.localSchema))) {
            this.localSchema = Object(deep_clone["a" /* default */])(v);
          }
        } else {
          this.localSchema = v;
        }
