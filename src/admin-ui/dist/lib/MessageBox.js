define("MessageBox", ["Vue"], function(__WEBPACK_EXTERNAL_MODULE__74__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
// EXTERNAL MODULE: ./src/admin-ui/src/components/modal/src/modal.vue + 4 modules
var modal = __webpack_require__(233);
...
// EXTERNAL MODULE: ./src/admin-ui/src/components/icon/src/icon.vue + 3 modules
var src_icon = __webpack_require__(135);
...
var input = __webpack_require__(211);
...
var prompt_component = Object(componentNormalizer["a" /* default */])(
...
function getInstance(type) {
  switch (type) {
    case 'modal':
      ...
      if (namespace["a" /* default */].get('adModalIntance')) {
        res = namespace["a" /* default */].get('adModalIntance');
      } else {
        res = new (external_Vue_default.a.extend(modal["a" /* default */]))({
          el: document.createElement('div')
        });
        if (res.$refs.decline) res.$refs.decline.parentNode.removeChild(res.$refs.decline);
        namespace["a" /* default */].set('adModalIntance', res);
      }

      return res;

    case 'alert':
      return namespace["a" /* default */].get('adAlertIntance') || namespace["a" /* default */].set('adAlertIntance', new (external_Vue_default.a.extend(src_alert))({
        el: document.createElement('div')
      }));

    case 'confirm':
      return namespace["a" /* default */].get('adConfirmIntance') || namespace["a" /* default */].set('adConfirmIntance', new (external_Vue_default.a.extend(src_confirm))({
        el: document.createElement('div')
      }));

    case 'prompt':
      return namespace["a" /* default */].get('adPromptIntance') || namespace["a" /* default */].set('adPromptIntance', new (external_Vue_default.a.extend(src_prompt))({
        el: document.createElement('div')
      }));
  }
} // get all instances
...
/* harmony default export */ var message_box = __webpack_exports__["a"] = (MessageBox);
...
/* harmony import */ var _src_message_box__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(252);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "default", function() { return _src_message_box__WEBPACK_IMPORTED_MODULE_0__["a"]; });
