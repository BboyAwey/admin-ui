define("Tagfactory", ["Vue"], function(__WEBPACK_EXTERNAL_MODULE__74__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var es6_string_repeat = __webpack_require__(285);
...
var src_loading = __webpack_require__(185);
...
/* harmony default export */ var tagfactoryvue_type_script_lang_js_ = ({
  ...
  watch: {
    ...
    loading: function loading(v) {
      ...
      if (v) {
        this.$nextTick(function () {
          _this2.loadingInstance = Object(src_loading["a" /* default */])({
  ...
  methods: {
    ...
    handleWindowClick: function handleWindowClick(e) {
      if (!Object(is_ancestor["a" /* default */])(e.target, this.$refs.body)) this.associationsShow = false;
    },
...
/* harmony default export */ var tagfactory = (component.exports);
// CONCATENATED MODULE: ./src/admin-ui/src/components/tagfactory/index.js
/* concated harmony reexport default */__webpack_require__.d(__webpack_exports__, "default", function() { return tagfactory; });
