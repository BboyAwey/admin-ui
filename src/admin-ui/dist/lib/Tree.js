define("Tree", [], function() { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/* harmony default export */ var treevue_type_script_lang_js_ = ({
  ...
  created: function created() {
    this.copyData = Object(deep_clone["a" /* default */])(this.treeData);
    this.setPos(this.copyData);
    this.showCheckbox && this.setCheckedType(this.copyData);
    this.computedTreeData = Object(deep_clone["a" /* default */])(this.copyData);
  },
  ...
  methods: {
    ...
    parseData: function parseData(data) {
      var newData = Object(deep_clone["a" /* default */])(data);
...
/* concated harmony reexport default */__webpack_require__.d(__webpack_exports__, "default", function() { return tree; });
