  ...
  methods: {
    ...
    render: function render(value) {
      function calcYmdObj(value) {
        var tempDate = null;
        if (typeof value === 'string' && value !== '' && !__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__helpers_utils__["a" /* isEmptyString */])(value)) {
    ...
    format: function format(value) {
      ...
      if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__helpers_utils__["a" /* isEmptyString */])(value)) return '';
    ...
    isSelected: function isSelected(dateObj) {
      ...
      if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__helpers_utils__["a" /* isEmptyString */])(this.inputValue)) return false;
