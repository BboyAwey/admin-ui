(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("admin-ui-breadcrumb-button-cascading-checkbox-collapse-datepicker-frame-grid-icon-input-json-schema-loading-menu-message-message-box-modal-paginator-panel-popover-previewer-radio-rangepicker-scroller-select-switch", ["vue"], factory);
	else if(typeof exports === 'object')
		exports["admin-ui-breadcrumb-button-cascading-checkbox-collapse-datepicker-frame-grid-icon-input-json-schema-loading-menu-message-message-box-modal-paginator-panel-popover-previewer-radio-rangepicker-scroller-select-switch"] = factory(require("vue"));
	else
		root["admin-ui-breadcrumb-button-cascading-checkbox-collapse-datepicker-frame-grid-icon-input-json-schema-loading-menu-message-message-box-modal-paginator-panel-popover-previewer-radio-rangepicker-scroller-select-switch"] = factory(root["Vue"]);
...
/******/ 	return __webpack_require__(__webpack_require__.s = "MWti");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return __WEBPACK_IMPORTED_MODULE_0__src_switch_vue__["a"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__helpers_dom_get_element_size__ = __webpack_require__("/PwX");
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    getLeft: function getLeft() {
      if (this.localValue) {
        var width = Object(__WEBPACK_IMPORTED_MODULE_3__helpers_dom_get_element_size__["a" /* default */])(this.$refs.switch).width;
