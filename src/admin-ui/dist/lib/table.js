      ...
      if (tbody.length) {
        for (var i = 0; i < tbody.length; i++) {
          ...
          for (var _i14 = 0; _i14 < trs.length; _i14++) {
            Object(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["b" /* removeClass */])(trs[_i14], 'au-theme-background-color--base-11');
          }
          if (this.striped) {
            ...
            for (var _i16 = 0; _i16 < trs.length; _i16++) {
              if (_i16 % 2 === 0) Object(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["b" /* removeClass */])(trs[_i16], 'au-theme-background-color--base-11');
            }
          }
        }
      } else {
        ...
        for (var _i17 = 0; _i17 < allTr.length; _i17++) {
          if (allTr[_i17].parentNode === table) {
            Object(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["b" /* removeClass */])(allTr[_i17], 'au-theme-background-color--base-11');
            if (this.striped) {
              if (_i17 % 2 === 0) Object(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["a" /* addClass */])(allTr[_i17], 'au-theme-background-color--base-11');
            } else {
              if (_i17 % 2 === 0) Object(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["b" /* removeClass */])(allTr[_i17], 'au-theme-background-color--base-11');
            }
          }
        }
      }
