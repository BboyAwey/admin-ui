...
"use strict";
/* unused harmony export getElementSize */
  ...
  methods: {
    handleAllStyle: function handleAllStyle() {
      ...
      for (var i = 0; i < allTr.length; i++) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["a" /* addClass */])(allTr[i], 'au-theme-border-color--base-8');
      }
      for (var _i = 0; _i < allTh.length; _i++) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["a" /* addClass */])(allTh[_i], 'au-theme-font-color--base-3');
      }
      for (var _i2 = 0; _i2 < allTd.length; _i2++) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["a" /* addClass */])(allTd[_i2], 'au-theme-font-color--base-3 au-theme-border-color--base-8');
      }

      for (var _i3 = 0; _i3 < tfoot.length; _i3++) {
        var tds = tfoot[_i3].querySelectorAll('td');
        for (var _i4 = 0; _i4 < tds.length; _i4++) {
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["a" /* addClass */])(tds[_i4], 'au-theme-font-color--base-6');
        }
      }
      ...
      for (var _i5 = 0; _i5 < thead.length; _i5++) {
        ...
        for (var _i6 = 0; _i6 < ths.length; _i6++) {
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["a" /* addClass */])(ths[_i6], 'au-theme-font-color--base-6 au-theme-border-color--base-8');
        }
      }
      ...
      if (tbody.length) {
        for (var _i7 = 0; _i7 < tbody.length; _i7++) {
          ...
          for (var _i8 = 0; _i8 < trs.length; _i8++) {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["a" /* addClass */])(trs[_i8], 'au-theme-hover-background-color--base-10');
          }
          if (this.striped) {
            for (var _i9 = 0; _i9 < trs.length; _i9++) {
              if (_i9 % 2 === 0) __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["a" /* addClass */])(trs[_i9], 'au-theme-background-color--base-11');
            }
          }
        }
      } else {
        for (var _i10 = 0; _i10 < allTr.length; _i10++) {
          if (allTr[_i10].parentNode === table) __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["a" /* addClass */])(allTr[_i10], 'au-theme-hover-background-color--base-10');
        }
        if (this.striped) {
          for (var _i11 = 0; _i11 < allTr.length; _i11++) {
            if (_i11 % 2 === 0) __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["a" /* addClass */])(allTr[_i11], 'au-theme-background-color--base-11');
          }
        }
      }
      ...
      if (thead.length) {
        for (var _i12 = 0; _i12 < thead.length; _i12++) {
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["a" /* addClass */])(thead[_i12].querySelector('tr:last-child'), 'au-theme-border-color--base-6-important');
        }
      }
      if (tbody.length && tfoot.length) {
        for (var _i13 = 0; _i13 < tbody.length; _i13++) {
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["a" /* addClass */])(tbody[_i13].querySelector('tr:last-child'), 'au-theme-border-color--base-6-important');
        }
      }
    },
      ...
      if (tbody.length) {
        for (var i = 0; i < tbody.length; i++) {
          ...
          for (var _i14 = 0; _i14 < trs.length; _i14++) {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["b" /* removeClass */])(trs[_i14], 'au-theme-background-color--base-11');
          }
          if (this.striped) {
            for (var _i15 = 0; _i15 < trs.length; _i15++) {
              if (_i15 % 2 === 0) __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["a" /* addClass */])(trs[_i15], 'au-theme-background-color--base-11');
            }
          } else {
            for (var _i16 = 0; _i16 < trs.length; _i16++) {
              if (_i16 % 2 === 0) __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["b" /* removeClass */])(trs[_i16], 'au-theme-background-color--base-11');
            }
          }
        }
      } else {
        ...
        for (var _i17 = 0; _i17 < allTr.length; _i17++) {
          if (allTr[_i17].parentNode === table) {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["b" /* removeClass */])(allTr[_i17], 'au-theme-background-color--base-11');
            if (this.striped) {
              if (_i17 % 2 === 0) __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["a" /* addClass */])(allTr[_i17], 'au-theme-background-color--base-11');
            } else {
              if (_i17 % 2 === 0) __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_dom__["b" /* removeClass */])(allTr[_i17], 'au-theme-background-color--base-11');
            }
          }
        }
      }
