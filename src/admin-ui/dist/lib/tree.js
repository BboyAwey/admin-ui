(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("admin-ui-breadcrumb-button-cascading-checkbox-collapse-datepicker-frame-grid-icon-input-loading-menu-message-message-box-modal-paginator-panel-popover-previewer-radio-rangepicker-scroller-select-switch-table-tabs-tag-tagfactory-timepicker-tree", [], factory);
	else if(typeof exports === 'object')
		exports["admin-ui-breadcrumb-button-cascading-checkbox-collapse-datepicker-frame-grid-icon-input-loading-menu-message-message-box-modal-paginator-panel-popover-previewer-radio-rangepicker-scroller-select-switch-table-tabs-tag-tagfactory-timepicker-tree"] = factory();
	else
		root["admin-ui-breadcrumb-button-cascading-checkbox-collapse-datepicker-frame-grid-icon-input-loading-menu-message-message-box-modal-paginator-panel-popover-previewer-radio-rangepicker-scroller-select-switch-table-tabs-tag-tagfactory-timepicker-tree"] = factory();
